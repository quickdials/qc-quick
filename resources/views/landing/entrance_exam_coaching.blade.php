                ...
                <div class="col-xs-12 col-sm-6 col-md-6 border-line formleftBlock">
				 ...
				 <div class="heading-txt">Why Fill This Form?</div>
                    <ul class="whyChoose">
                        ...
                        <li><span><img src="<?php echo asset('client/images/icon-1.png'); ?>"></span>G-21, Third Floor, Sector-3, Noida, 201301, Email:- info@quickdials, Phone:-9818798937, Website:- www.quickdials.com</li>
                    </ul>
                </div>
