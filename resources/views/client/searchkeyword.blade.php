		...
		<?php if(!empty($clientLists)): ?>
			...
			?>
				...
				<figure>
				    ...
				    <img class="" src="<?php echo url($image); ?>" alt="{{ $client->business_name }}" style="width:100%;">
	   ...
	   <div class="col-xs-12"> 				
		...
		<?php if(!empty($clientLists)): ?>
			...
			?>
				...
				<figure><img class="" src="<?php echo url('public'.$image); ?>" style="width:100%;" alt="{{ $business_name->business_name }}"></figure>
				<div class="grid-info">
					<h3><a href="{{url('business-details').'/'.generate_slug($client->business_slug)}}" title="{{$client->business_name}}" tabindex="0"><div title="{{$client->business_name}}"><strong>{{$client->business_name}}</strong></div></a></h3>
