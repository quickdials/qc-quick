		...
		<div class="">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h4>Add Role Permission<br/><small style="color:red">(Please use underscore inspite of space)</small></h4>
							<div class="clearfix"></div>
						</div>
						<div class="x_content">
							<br />
							...
							<form id="demo-form2" class="form-horizontal form-label-left" action="#" method="POST" action="{{url('developer/role-permission')}}" >
