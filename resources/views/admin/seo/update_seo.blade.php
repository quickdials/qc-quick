                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/developer/seo/'.$keyword->id) }}">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea class="form-control" name="top_description" placeholder="Enter Page Top Description" rows="10">{{ $keyword->top_description }}</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea class="form-control tinymce-selector" name="bottom_description" placeholder="Enter Page Bottom Description" rows="10">{{ $keyword->bottom_description }}</textarea>
									</div>
								</div>	
