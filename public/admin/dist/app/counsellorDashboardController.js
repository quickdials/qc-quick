...
app.controller('counsellorDashboard',['$scope','$http',function($scope,$http){
	...
	$http
	.get("/developer/lead-dashboard/counsellor")
	.then(function(response){
		...
		$scope.dcs_total_assign_lead = response.data.response.daily_calling_status.total_assign_lead;
		$scope.dcs_total_assign_lead_percent = response.data.response.daily_calling_status.total_assign_lead_percent;	

		$scope.dcs_total_client_assign = response.data.response.daily_calling_status.total_client_assign;
		$('.assign').html($scope.dcs_total_client_assign);
		$scope.dcs_total_client_assign_percent = response.data.response.daily_calling_status.total_client_assign_percent;
		...
		$scope.wcs_total_assign_lead = response.data.response.weekly_calling_status.total_assign_lead;
		$scope.wcs_total_assign_lead_percent = response.data.response.weekly_calling_status.total_assign_lead_percent;
		
		$scope.wcs_total_client_assign = response.data.response.weekly_calling_status.total_client_assign;
		$scope.wcs_total_cleint_assign_percent = response.data.response.weekly_calling_status.total_cleint_assign_percent;
	...
	$('.counsellor-control' ).on('change',function(){		
		...
		$http
		.get("/developer/lead-dashboard/counsellor/"+user_id)
		.then(function(response){ 
			//alert(JSON.stringify(response));
			$scope.total_leads = response.data.response.total_leads;
	...
	/* $scope.getCoumsellerlist = function(msg){
		...
		$http
		.get("/developer/lead-dashboard/"+user_id)
		.then(function(response){
			//alert(JSON.stringify(response));
			$scope.total_leads = response.data.response.total_leads;
			$scope.total_interested = response.data.response.total_interested;
	...
	$scope.getCallingStatus = function(){
		...
		$scope.dcs_DateRangePicker = !$scope.dcs_DateRangePicker;
		$http
		.post("/developer/lead-dashboard/daily-calling-status"+user_id,
			{
				"fromDate":fromDate,
				"toDate":toDate
			}
		...
		.then(function(response){
			//alert(response.data.response.daily_calling_status.new_lead);
			$scope.dcs_new_lead = response.data.response.daily_calling_status.new_lead;
			$scope.dcs_new_lead_percent = response.data.response.daily_calling_status.new_lead_percent;
			$scope.dcs_interested = response.data.response.daily_calling_status.interested;
			$scope.dcs_interested_percent = response.data.response.daily_calling_status.interested_percent;
